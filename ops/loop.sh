...
#
# At tier 3 the agent writes intent/<slug>/intent.md and nothing else: it has no git beyond log and show,
# and it commits nothing. ops/propose.sh checks the file and is what commits, pushes and opens the PR.
set -euo pipefail
propose=yes
