...
- Protected paths (`.claude/protected-paths`: the hooks, the list itself, and `.github/workflows/**`) are guarded by a hook; an edit there is already a blocked action, not a review finding.
